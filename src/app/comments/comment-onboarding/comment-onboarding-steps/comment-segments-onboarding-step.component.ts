...
@Component({
    selector: 'app-comment-segments-onboarding-step',
...
export class CommentSegmentsOnboardingStepComponent {
    protected readonly onboarding = inject(OnboardingService);
}

export const COMMENT_SEGMENTS_ONBOARDING_STEP = new PolymorpheusComponent(
    CommentSegmentsOnboardingStepComponent,
);
